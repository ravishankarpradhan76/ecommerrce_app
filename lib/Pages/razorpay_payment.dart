import 'package:ecommerrce_app/Widgets/round_button.dart';
...
class _RazorpayPaymentState extends State<RazorpayPayment> {
  ...
  void handlePayementError(PaymentFailureResponse response) {
    Fluttertoast.showToast(
        msg: "payment Failled" + response.message!,
        toastLength: Toast.LENGTH_SHORT);
  }
  ...
  void initState() {
    super.initState();
    _razorpay = Razorpay();
    _razorpay.on(Razorpay.EVENT_PAYMENT_SUCCESS, handlePayementSuccess);
    _razorpay.on(Razorpay.EVENT_PAYMENT_ERROR, handlePayementError);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Image.network(
              'https://media.licdn.com/dms/image/C5603AQHSAAC'
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: RoundButton(title: 'make payment', onTap:(){
